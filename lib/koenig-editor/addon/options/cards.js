...
export const CARD_COMPONENT_MAP = {
    ...
    locations: 'koenig-card-locations'
};
...
export const CARD_ICON_MAP = {
    ...
    locations: 'koenig/kg-card-type-locations'
};
...
export default [
    ...
    createComponentCard('locations', {deleteIfEmpty: 'payload.locations'})
];
...
export const CARD_MENU = [
    {
        ...
        {
            label: 'Locations',
            icon: 'koenig/kg-card-type-locations',
            iconClass: 'kg-card-type-native',
            matches: ['locations'],
            type: 'card',
            replaceArg: 'locations'
        }]
    },
    {
        title: '内嵌',
