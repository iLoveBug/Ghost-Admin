...
export const CARD_COMPONENT_MAP = {
    ...
    locationList: 'koenig-card-location-list'
};
...
export const CARD_ICON_MAP = {
    ...
    locationList: 'koenig/kg-card-type-location-list'
};
...
export default [
    ...
    createComponentCard('locationList', {deleteIfEmpty: 'payload.locationList'})
];
...
export const CARD_MENU = [
    {
        ...
        {
            label: 'LocationList',
            icon: 'koenig/kg-card-type-location-list',
            iconClass: 'kg-card-type-native',
            matches: ['locationList'],
            type: 'card',
            replaceArg: 'locationList'
        }]
    },
    {
        title: '内嵌',
